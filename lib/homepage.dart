...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildTopProductsList() {
    List topProductList = [
      TopProductTile(
        assetPath: 'assets/images/oil1.jpg',
        color: Color(0xffDFECF8),
        price: '\$2.25',
        title: 'Mustard Oil',
      ),
      TopProductTile(
        ...
        assetPath: 'assets/images/pulses.png',
        title: 'Pulses',
        price: '\$1.50',
      ),
      TopProductTile(
        color: Color(0xffFFF2C5),
        assetPath: 'assets/images/flour.png',
        title: 'Flour',
        price: '\$3.50',
      ),
      TopProductTile(
        color: Colors.brown[200],
        assetPath: 'assets/images/jam.jpg',
        title: 'Jam',
        price: '\$3.50',
      ),
      TopProductTile(
        color: Colors.indigo[100],
        assetPath: 'assets/images/choco.jpg',
        title: 'Chocolates',
        price: '\$3.50',
      ),
    ];
